...
TIF_PATH = "normal_001.tif"
OUTPUT_DIR = "benign_cut_output"

TARGET_SLIDE_ID = "normal_001"
PATCH_SIZE = 256
...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        print(
            f"[Done] Saved to: {save_path} | time used: {patch_elapsed:.2f}s",
            flush=True
        )
    ...
    print(f"Total time used: {total_elapsed:.2f}s")
